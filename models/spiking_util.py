...
class BaseSpike(torch.autograd.Function): # https://pytorch.org/tutorials/beginner/examples_autograd/polynomial_custom_function.html 
    """
    ...
    def forward(ctx, x, width):
        ...
        return x.gt(0).float() # Computes input(x) > other(0) element-wise. https://pytorch.org/docs/stable/generated/torch.gt.html 
